...
import { getArbitrumFactoryRegistry, getArbitrumMulticall } from '../../utils/getters';
...
export default fn(async (query) => {
    ...
    let registryAddress = await getArbitrumFactoryRegistry()
    let multicallAddress = getArbitrumMulticall()
