...
const configs = {
  ethereum: {
    ...
    BROKEN_POOLS_ADDRESSES: [
      ...
      '0x95591348FE9718bE8bfa3afcC9b017D9Ec18A7fa', // Deprecated pool and causing issues
  ...
  polygon: {
    ...
    chainId: 137,
    nativeCurrencyCoingeckoId: 'polygon-ecosystem-token',
    platformCoingeckoId: 'polygon-pos',
    nativeAssetErc20WrapperId: 'wmatic',
    rpcUrl: `https://direct.drpc.org/ogrpc?network=polygon&dkey=${process.env.DRPC_API_KEY}`,
    ...
    gaugeRegistryAddress2: '0x55a1C26CE60490A15Bdd6bD73De4F6346525e01e',
  ...
  fantom: {
    ...
    rpcUrl: `https://direct.drpc.org/ogrpc?network=fantom&dkey=${process.env.DRPC_API_KEY}`,
    ...
    getFactoryTwocryptoRegistryAddress: async () => '0x98EE851a00abeE0d95D08cF4CA2BdCE32aeaAF7F',
    gaugeRegistryAddress2: '0x004A476B5B76738E34c86C7144554B9d34402F13',
    gaugeRootRegistry2: '0x306A45a1478A000dC701A6e1f7a569afb8D9DCD6',
    factoryImplementationAddressMap: new Map([
  ...
  arbitrum: {
    ...
    rpcUrl: `https://direct.drpc.org/ogrpc?network=arbitrum&dkey=${process.env.DRPC_API_KEY}`,
    ...
    gaugeRegistryAddress2: '0x988d1037e9608B21050A8EFba0c6C45e01A3Bce7',
    gaugeRootRegistry2: '0x306A45a1478A000dC701A6e1f7a569afb8D9DCD6',
    factoryImplementationAddressMap: new Map([
  ...
  avalanche: {
    ...
    rpcUrl: `https://direct.drpc.org/ogrpc?network=avalanche&dkey=${process.env.DRPC_API_KEY}`,
    ...
    gaugeRegistryAddress2: '0x97aDC08FA1D849D2C48C5dcC1DaB568B169b0267',
    gaugeRootRegistry2: '0x306A45a1478A000dC701A6e1f7a569afb8D9DCD6',
    factoryImplementationAddressMap: new Map([
  ...
  optimism: {
    ...
    nativeAssetErc20WrapperId: 'weth', // Used by crypto facto, since it handles wrapped native as native
    rpcUrl: `https://direct.drpc.org/ogrpc?network=optimism&dkey=${process.env.DRPC_API_KEY}`,
    ...
    gaugeRegistryAddress2: '0x871fBD4E01012e2E8457346059e8C189d664DbA4',
    gaugeRootRegistry2: '0x306A45a1478A000dC701A6e1f7a569afb8D9DCD6',
    factoryImplementationAddressMap: new Map([
  ...
  xdai: {
    ...
    rpcUrl: `https://direct.drpc.org/ogrpc?network=gnosis&dkey=${process.env.DRPC_API_KEY}`,
    ...
    gaugeRegistryAddress2: '0x7BE6BD57A319A7180f71552E58c9d32Da32b6f96',
    gaugeRootRegistry2: '0x306A45a1478A000dC701A6e1f7a569afb8D9DCD6',
  ...
  moonbeam: {
    ...
    rpcUrl: `https://direct.drpc.org/ogrpc?network=moonbeam&dkey=${process.env.DRPC_API_KEY}`,
    ...
    gaugeRegistryAddress2: '0xe35A879E5EfB4F1Bb7F70dCF3250f2e19f096bd8',
    gaugeRootRegistry2: '0x306A45a1478A000dC701A6e1f7a569afb8D9DCD6',
    factoryImplementationAddressMap: new Map([
  ...
  kava: {
    ...
    rpcUrl: `https://direct.drpc.org/ogrpc?network=kava&dkey=${process.env.DRPC_API_KEY}`,
  ...
  celo: {
    ...
    rpcUrl: `https://direct.drpc.org/ogrpc?network=celo&dkey=${process.env.DRPC_API_KEY}`,
  ...
  zkevm: {
    ...
    nativeAssetErc20WrapperId: 'weth', // Used by crypto facto, since it handles wrapped native as native
    rpcUrl: `https://direct.drpc.org/ogrpc?network=polygon-zkevm&dkey=${process.env.DRPC_API_KEY}`,
    ...
    gaugeRegistryAddress2: '0x3c0a405E914337139992625D5100Ea141a9C4d11',
    gaugeRootRegistry2: '0x306A45a1478A000dC701A6e1f7a569afb8D9DCD6',
    factoryImplementationAddressMap: new Map([
  ...
  zksync: {
    ...
    getFactoryStableswapNgRegistryAddress: async () => '0xFcAb5d04e8e031334D5e8D2C166B08daB0BE6CaE',
    getFactoryTwocryptoRegistryAddress: async () => '0xf3a546AF64aFd6BB8292746BA66DB33aFAE72114',
    getFactoryTricryptoRegistryAddress: async () => '0x5d4174C40f1246dABe49693845442927d5929f0D',
    gaugeRegistryAddress2: '0x167D9C27070Ce04b79820E6aaC0cF243d6098812',
    gaugeRootRegistry2: '0x306A45a1478A000dC701A6e1f7a569afb8D9DCD6',
    factoryImplementationAddressMap: new Map([
      ['0x04D0095a1A4Ae881a078ae61F36945E85464e6d7'.toLowerCase(), 'plainstableng'],
      ['0xC5d5402481aefec461Ab86b1051AC26dF05BeE3B'.toLowerCase(), 'metausdstableng'],
      ['0x0d74e4315AC9Ea0CE299CF1238481e9311574e48'.toLowerCase(), 'twocrypto-optimized'],
    ]),
    BASE_POOL_LP_TO_GAUGE_LP_MAP: new Map([]),
    DISABLED_POOLS_ADDRESSES: [].map(lc),
  ...
  base: {
    ...
    nativeAssetErc20WrapperId: 'weth', // Used by crypto facto, since it handles wrapped native as native
    rpcUrl: `https://direct.drpc.org/ogrpc?network=base&dkey=${process.env.DRPC_API_KEY}`,
  ...
  fraxtal: {
    ...
    gaugeRegistryAddress2: '0x0B8D6B6CeFC7Aa1C2852442e518443B1b22e1C52',
    gaugeRootRegistry2: '0x306A45a1478A000dC701A6e1f7a569afb8D9DCD6',
    factoryImplementationAddressMap: new Map([
  ...
  bsc: {
    ...
    rpcUrl: `https://direct.drpc.org/ogrpc?network=bsc&dkey=${process.env.DRPC_API_KEY}`,
  ...
  'x-layer': {
    ...
    gaugeRegistryAddress2: '0xD5C3e070E121488806AaA5565283A164ACEB94Df',
    gaugeRootRegistry2: '0x306A45a1478A000dC701A6e1f7a569afb8D9DCD6',
    factoryImplementationAddressMap: new Map([
      //
    ]),
  ...
  mantle: {
    ...
    rpcUrl: `https://direct.drpc.org/ogrpc?network=mantle&dkey=${process.env.DRPC_API_KEY}`,
