...
import factoryV2RegistryAbi from '#root/constants/abis/factory-v2-registry.json' with { type: 'json' };
import factoryPoolAbi from '#root/constants/abis/factory-v2/Plain2Balances.json' with { type: 'json' };
import factoryCryptoRegistryAbi from '#root/constants/abis/factory-crypto-registry.json' with { type: 'json' };
import factoryCrvusdRegistryAbi from '#root/constants/abis/factory-crvusd/registry.json' with { type: 'json' };
import factoryTwocryptoRegistryAbi from '#root/constants/abis/factory-twocrypto/registry.json' with { type: 'json' };
import factoryTricryptoRegistryAbi from '#root/constants/abis/factory-tricrypto/registry.json' with { type: 'json' };
import factoryStableswapNgRegistryAbi from '#root/constants/abis/factory-stableswap-ng/registry.json' with { type: 'json' };
import factoryEywaRegistryAbi from '#root/constants/abis/fantom/factory-eywa/registry.json' with { type: 'json' };
import cryptoRegistryAbi from '#root/constants/abis/crypto-registry.json' with { type: 'json' };
import factoryCryptoPoolAbi from '#root/constants/abis/factory-crypto/factory-crypto-pool-2.json' with { type: 'json' };
import factoryTwocryptoPoolAbi from '#root/constants/abis/factory-twocrypto/pool.json' with { type: 'json' };
import factoryTricryptoPoolAbi from '#root/constants/abis/factory-crypto/factory-crypto-pool-2.json' with { type: 'json' };
import factoryStableNgPoolAbi from '#root/constants/abis/factory-stableswap-ng/pool.json' with { type: 'json' };
import factoryCrvusdPoolAbi from '#root/constants/abis/factory-crvusd/pool.json' with { type: 'json' };
import factoryEywaPoolAbi from '#root/constants/abis/fantom/factory-eywa/pool.json' with { type: 'json' };
import erc20Abi from '#root/constants/abis/erc20.json' with { type: 'json' };
import erc20AbiMKR from '#root/constants/abis/erc20_mkr.json' with { type: 'json' };
...
const EXTERNAL_ORACLE_COINS_ADDRESSES = {
  ethereum: [
    ...
    '0xE72B141DF173b999AE7c1aDcbF60Cc9833Ce56a8', // temp
  ].map(lc),
  base: [
