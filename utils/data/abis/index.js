import compoundSwapABI from './json/compound/swap.json' with { type: 'json' };
import usdtSwapABI from './json/usdt/swap.json' with { type: 'json' };
import iearnSwapABI from './json/iearn/swap.json' with { type: 'json' };
import iearnSCurveRewardsABI from './json/iearn/sCurveRewards.json' with { type: 'json' };
import busdSwapABI from './json/busd/swap.json' with { type: 'json' };
import susdv2SwapABI from './json/susdv2/swap.json' with { type: 'json' };
import susdv2SCurveRewardsAbi from './json/susdv2/sCurveRewards.json' with { type: 'json' };
import paxSwapABI from './json/pax/swap.json' with { type: 'json' };
import renSwapABI from './json/ren/swap.json' with { type: 'json' };
import sbtcSwapABI from './json/sbtc/swap.json' with { type: 'json' };
import sbtcSCurveRewardsABI from './json/sbtc/sCurveRewards.json' with { type: 'json' };
import hbtcSwapABI from './json/hbtc/swap.json' with { type: 'json' };
import tripoolSwapABI from './json/3pool/swap.json' with { type: 'json' };
import gusdSwapABI from './json/gusd/swap.json' with { type: 'json' };
import husdSwapABI from './json/husd/swap.json' with { type: 'json' };
import usdkSwapABI from './json/usdk/swap.json' with { type: 'json' };
import usdnSwapABI from './json/usdn/swap.json' with { type: 'json' };
import linkusdSwapABI from './json/linkusd/swap.json' with { type: 'json' };
import musdSwapABI from './json/musd/swap.json' with { type: 'json' };
import musdSCurveRewardsAbi from './json/musd/sCurveRewards.json' with { type: 'json' };
import rsvSwapABI from './json/rsv/swap.json' with { type: 'json' };
import rsvSCurveRewardsAbi from './json/rsv/sCurveRewards.json' with { type: 'json' };
import tbtcSwapABI from './json/tbtc/swap.json' with { type: 'json' };
import tbtcSCurveRewardsAbi from './json/tbtc/sCurveRewards.json' with { type: 'json' };
import dusdSwapABI from './json/dusd/swap.json' with { type: 'json' };
import dusdSCurveRewardsAbi from './json/dusd/sCurveRewards.json' with { type: 'json' };
import pbtcSwapABI from './json/pbtc/swap.json' with { type: 'json' };
import pbtcSCurveRewardsAbi from './json/pbtc/sCurveRewards.json' with { type: 'json' };
import bbtcSwapABI from './json/bbtc/swap.json' with { type: 'json' };
import obtcSwapABI from './json/obtc/swap.json' with { type: 'json' };
import obtcSCurveRewardsAbi from './json/obtc/sCurveRewards.json' with { type: 'json' };
import sethSwapABI from './json/seth/swap.json' with { type: 'json' };
import eursSwapABI from './json/eurs/swap.json' with { type: 'json' };
import eursSCurveRewardsAbi from './json/eurs/sCurveRewards.json' with { type: 'json' };
import ustSwapABI from './json/ust/swap.json' with { type: 'json' };
import aaveSwapABI from './json/aave/swap.json' with { type: 'json' };
import idleSwapABI from './json/idle/swap.json' with { type: 'json' };
import stethSwapABI from './json/steth/swap.json' with { type: 'json' };
import stethSCurveRewardsAbi from './json/steth/sCurveRewards.json' with { type: 'json' };
import saaveSwapABI from './json/saave/swap.json' with { type: 'json' };
import ankrethSwapABI from './json/ankreth/swap.json' with { type: 'json' };
import ankrethSCurveRewardsAbi from './json/ankreth/sCurveRewards.json' with { type: 'json' };
import usdpSwapABI from './json/usdp/swap.json' with { type: 'json' };
import ibSwapABI from './json/ib/swap.json' with { type: 'json' };
import linkSwapABI from './json/link/swap.json' with { type: 'json' };
import tusdSwapABI from './json/tusd/swap.json' with { type: 'json' };
import fraxSwapABI from './json/frax/swap.json' with { type: 'json' };
import lusdSwapABI from './json/lusd/swap.json' with { type: 'json' };
import lusdRewardsabi from './json/lusd/rewards.json' with { type: 'json' };
import balancerAbi from './json/balancer.json' with { type: 'json' };
import rethSwapABI from './json/reth/swap.json' with { type: 'json' };
import fraxRewardsabi from './json/frax/rewards.json' with { type: 'json' };
import alusdSwapABI from './json/alusd/swap.json' with { type: 'json' };
import triCryptoSwap from './json/tricrypto/swap.json' with { type: 'json' };
